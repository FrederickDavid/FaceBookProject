...
const Home = ({image,
    ...
    firstname}) => {
        ...
        const myData = async ()=>{
            await app.firestore().collection("postcontent").onSnapshot((snapshot)=>{
                const store = []
        ...
        <MainContainer>
            ...
            <Wrapper>
                <Left>
                    <LeftItem>
                        <IconAndText>
                                <Icon src={headerData.avatar}br/>
                            <span>{headerData?.name} {" "} {headerData?.surname}</span>
                        </IconAndText>
                        <IconAndText mt mb>
                                <Icon src={a}/>
                            <span>Friends</span>
                ...
                <Center>
                    ...
                    <HomePost>
                    <PIcAndWhat>
                        <ThePic src={headerData?.avatar}/>
                        <Inputs placeholder={`What's on your mind ${headerData?.name  +" " + headerData?.surname} `}
                ...
                <Center>
                    ...
                    <HomeMainPost>
                       {data.map((props)=>(
                           <ThePost>
                           <PicNameTime>
                               <FirstProfile src={props.profile}/>
                               <NameTime>
                                   <PosterName>{props.firstname} {" "} {props.surname}</PosterName>
                                   <PosterDate>2mins</PosterDate>
                               </NameTime>
                           </PicNameTime>
                           <WriteUp>{props.content}</WriteUp>
                           <PostPictures src={props.image}/>
                          {likeToggle? ( <LikeNameComment>
                             <Onw>
                              <Like/>
                           ...
                           </LikeNameComment>) : null}
                           <LiveCommentIcon>
                             {likeToggle? (  <LikeClickHolder fs="20px" bg="blue" onClick={()=>{
                                 onLikeToggle()
                             }}>
                                   <AiFillLike/>
                                   <span>Like</span>
                               ...
                               :
                               ( <LikeClickHolder fs="20px" onClick={()=>{
                                   onLikeToggle()
                               }}>
                                   <AiOutlineLike/>
                                   <span>Like</span>
